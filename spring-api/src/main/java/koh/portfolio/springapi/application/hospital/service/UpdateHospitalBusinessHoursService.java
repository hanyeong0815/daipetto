...
public class UpdateHospitalBusinessHoursService implements UpdateHospitalBusinessHoursUseCase {
    private final HospitalBusinessHoursRepository hospitalBusinessHoursRepository;

    @Override
    @Transactional
    public void execute(Long hospitalId, Long businessHoursId, UpdateHospitalBusinessHoursRequest request) {
        ...
        HospitalBusinessHours updatedBusinessHours = businessHours.update(
                request.openTime(),
                request.closeTime(),
